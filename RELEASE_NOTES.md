...
- **Configurable log-event chunk size**: `LOG_EVENT_CHUNK_SIZE` / `log-event-chunk-size` controls how many log IDs are requested per `RequestLog` (default and hard ceiling **999**).
